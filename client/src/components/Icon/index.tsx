...
export const InstagramIcon = ({ className }: Icon) => {
    return (
        <svg
...
export const BigPlusIcon = ({ className }: Icon) => {
    return (
        <svg
...
export const FindIcon = ({ className }: Icon) => {
    return (
        <svg
            aria-label="Tìm kiếm"
            className={className}
...
export const DiscoverIcon = ({ className }: Icon) => {
    return (
        <svg
            aria-label="Khám phá"
            className={className}
...
export const ReelsIcon = ({ className }: Icon) => {
    return (
        <svg
            aria-label="Reels"
            className={className}
...
export const MessengerIcon = ({ className }: Icon) => {
    return (
        <svg
...
export const CommentIcon = ({ className }: Icon) => {
    return (
        <svg
...
export const SharingIcon = ({ className }: Icon) => {
    return (
        <svg
...
export const SavingIcon = ({ className }: Icon) => {
    return (
        <svg
            aria-label="Lưu"
            className={className}
...
export const CreateIcon = ({ className }: Icon) => {
    return (
        <svg
